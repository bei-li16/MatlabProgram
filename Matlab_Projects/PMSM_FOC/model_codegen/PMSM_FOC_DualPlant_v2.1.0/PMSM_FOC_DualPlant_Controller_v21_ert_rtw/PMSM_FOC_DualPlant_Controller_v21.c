...
void PMSM_FOC_DualPlant_Controller_v21_step(void)
{
   ...
   */
  rtb_Phase_Vb = cosf(PMSM_FOC_DualPlant_Controller_U.ElectricalAngleRad);

  /* Trigonometry: '<S1>/SinTheta' incorporates:
   *  Inport: '<Root>/ElectricalAngleRad'
   */
  rtb_Phase_Vc = sinf(PMSM_FOC_DualPlant_Controller_U.ElectricalAngleRad);
   ...
   */
  PMSM_FOC_DualPlant_Controller_Y.IdMeasured = rtb_Phase_Vb *
    PMSM_FOC_DualPlant_Controller_U.PhaseCurrentA + rtb_Phase_Vc *
    PMSM_FOC_DualPlant_Controller_Y.IqMeasured;
   ...
   */
  PMSM_FOC_DualPlant_Controller_Y.IqMeasured = rtb_Phase_Vc *
    PMSM_FOC_DualPlant_Controller_U.PhaseCurrentA *
    PMSM_FOC_DualPlant_Controller_P.Iq_Negative_Gain + rtb_Phase_Vb *
    PMSM_FOC_DualPlant_Controller_Y.IqMeasured;
  ...
  if (PMSM_FOC_DualPlant_Controlle_M->Timing.TaskCounters.TID[1] == 0) {
     ...
     *  Sum: '<S1>/Speed_Error'
     */
    rtb_Speed_RpmToRad = (PMSM_FOC_DualPlant_Controller_U.SpeedReferenceRpm -
                          PMSM_FOC_DualPlant_Controller_U.SpeedRpm) *
    ...
    PMSM_FOC_DualPlant_Controller_B.Iq_Reference_Limit = FOC_Native_KpSpeed *
      rtb_Speed_RpmToRad +
      PMSM_FOC_DualPlant_Controlle_DW.Speed_Integrator_State_DSTATE;
   ...
   */
  rtb_Iq_Error = PMSM_FOC_DualPlant_Controller_B.Iq_Reference_Limit -
    PMSM_FOC_DualPlant_Controller_Y.IqMeasured;
  ...
  PMSM_FOC_DualPlant_Controller_Y.VqCommand = (FOC_Native_Ld *
    ...
    rtb_Iq_Error + PMSM_FOC_DualPlant_Controlle_DW.Iq_Integrator_State_DSTATE);
   ...
   */
  rtb_Id_Error = PMSM_FOC_DualPlant_Controller_P.Id_Reference_Zero_Value -
   ...
   */
  PMSM_FOC_DualPlant_Controller_Y.VdCommand = (FOC_Native_KpCurrent *
    rtb_Id_Error + PMSM_FOC_DualPlant_Controlle_DW.Id_Integrator_State_DSTATE) +
    PMSM_FOC_DualPlant_Controller_Y.VdCommand *
   ...
   */
  rtb_Valpha_Sum = rtb_Phase_Vb * PMSM_FOC_DualPlant_Controller_Y.VdCommand -
   ...
   */
  rtb_Phase_Vc = rtb_Phase_Vc * PMSM_FOC_DualPlant_Controller_Y.VdCommand +
    rtb_Phase_Vb * PMSM_FOC_DualPlant_Controller_Y.VqCommand;
   ...
   */
  PMSM_FOC_DualPlant_Controller_Y.DutyB = (rtb_Phase_Vb + rtb_Iq_Integrator_Add)
   ...
   */
  PMSM_FOC_DualPlant_Controller_Y.DutyA = (rtb_Valpha_Sum +
    rtb_Iq_Integrator_Add) / PMSM_FOC_DualPlant_Controller_U.DcBusVoltage +
    PMSM_FOC_DualPlant_Controller_P.Duty_Half_Value;
   ...
   */
  PMSM_FOC_DualPlant_Controller_Y.DutyC = (rtb_Phase_Vc + rtb_Iq_Integrator_Add)
    / PMSM_FOC_DualPlant_Controller_U.DcBusVoltage +
    PMSM_FOC_DualPlant_Controller_P.Duty_Half_Value;
   ...
   *  UnitDelay: '<S1>/Id_Integrator_State'
   */
  PMSM_FOC_DualPlant_Controlle_DW.Id_Integrator_State_DSTATE += rtb_Phase_Vc *
    rtb_Id_Error;

  /* Saturate: '<S1>/Id_Integrator_Limit' */
  if (PMSM_FOC_DualPlant_Controlle_DW.Id_Integrator_State_DSTATE >
      FOC_Native_CurrentIntegratorLimit) {
    /* Sum: '<S1>/Id_Integrator_Add' */
    PMSM_FOC_DualPlant_Controlle_DW.Id_Integrator_State_DSTATE =
      FOC_Native_CurrentIntegratorLimit;
  } else if (PMSM_FOC_DualPlant_Controlle_DW.Id_Integrator_State_DSTATE <
             -FOC_Native_CurrentIntegratorLimit) {
    /* Sum: '<S1>/Id_Integrator_Add' */
    PMSM_FOC_DualPlant_Controlle_DW.Id_Integrator_State_DSTATE =
      -FOC_Native_CurrentIntegratorLimit;
   ...
   *  UnitDelay: '<S1>/Iq_Integrator_State'
   */
  PMSM_FOC_DualPlant_Controlle_DW.Iq_Integrator_State_DSTATE += rtb_Phase_Vc *
    rtb_Iq_Error;

  /* Saturate: '<S1>/Iq_Integrator_Limit' */
  if (PMSM_FOC_DualPlant_Controlle_DW.Iq_Integrator_State_DSTATE >
      FOC_Native_CurrentIntegratorLimit) {
    /* Sum: '<S1>/Iq_Integrator_Add' */
    PMSM_FOC_DualPlant_Controlle_DW.Iq_Integrator_State_DSTATE =
      FOC_Native_CurrentIntegratorLimit;
  } else if (PMSM_FOC_DualPlant_Controlle_DW.Iq_Integrator_State_DSTATE <
             -FOC_Native_CurrentIntegratorLimit) {
    /* Sum: '<S1>/Iq_Integrator_Add' */
    PMSM_FOC_DualPlant_Controlle_DW.Iq_Integrator_State_DSTATE =
      -FOC_Native_CurrentIntegratorLimit;
  ...
  if (PMSM_FOC_DualPlant_Controlle_M->Timing.TaskCounters.TID[1] == 0) {
    ...
    if (PMSM_FOC_DualPlant_Controlle_DW.Speed_Integrator_State_DSTATE >
        FOC_Native_IqLimit) {
      /* Sum: '<S1>/Speed_Integrator_Add' */
      PMSM_FOC_DualPlant_Controlle_DW.Speed_Integrator_State_DSTATE =
        FOC_Native_IqLimit;
    } else if (PMSM_FOC_DualPlant_Controlle_DW.Speed_Integrator_State_DSTATE <
               -FOC_Native_IqLimit) {
      /* Sum: '<S1>/Speed_Integrator_Add' */
      PMSM_FOC_DualPlant_Controlle_DW.Speed_Integrator_State_DSTATE =
        -FOC_Native_IqLimit;
...
void PMSM_FOC_DualPlant_Controller_v21_initialize(void)
{
   ...
   */
  PMSM_FOC_DualPlant_Controlle_DW.Speed_Integrator_State_DSTATE =
    PMSM_FOC_DualPlant_Controller_P.Speed_Integrator_State_InitialC;

  /* InitializeConditions for Sum: '<S1>/Iq_Integrator_Add' incorporates:
   *  UnitDelay: '<S1>/Iq_Integrator_State'
   */
  PMSM_FOC_DualPlant_Controlle_DW.Iq_Integrator_State_DSTATE =
    PMSM_FOC_DualPlant_Controller_P.Iq_Integrator_State_InitialCond;

  /* InitializeConditions for Sum: '<S1>/Id_Integrator_Add' incorporates:
   *  UnitDelay: '<S1>/Id_Integrator_State'
   */
  PMSM_FOC_DualPlant_Controlle_DW.Id_Integrator_State_DSTATE =
    PMSM_FOC_DualPlant_Controller_P.Id_Integrator_State_InitialCond;
}
