...
report.HasFastSafety = contains(sourceText, 'Fault_Latch_State') && ...
    contains(sourceText, 'OverCurrentA') && ...
    contains(sourceText, 'OverCurrentB') && contains(sourceText, 'PWM_Permit');
...
taskBoundaryPaths = {'IqRef_Rate_Transition', 'FastFault_To_1ms', ...
    'CalibrationDone_To_1ms', 'SupervisorPwmEnable_To_100us', ...
    'CalibrationEnable_To_100us', 'CalibrationReset_To_100us', ...
    'AlignmentEnable_To_100us', 'ControllerReset_To_100us'};
...
report.ControllerFastSafetyPresent = getSimulinkBlockHandle( ...
    [controllerName '/Fast_Safety_Gate_100us']) ~= -1;
report.HarnessFastSafetyPresent = getSimulinkBlockHandle( ...
    [harnessName '/Fast_Safety_Gate_100us']) ~= -1;
...
report.FastSafetySampleTime = str2double(get_param( ...
    [controllerName '/Fast_Safety_Gate_100us/Fault_Latch_State'], ...
    'SampleTime'));
