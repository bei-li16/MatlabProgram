...
% dual-rate protection input conditioning. A seventh controller input carries the
...
annotation = Simulink.Annotation(parent, sprintf([ ...
    ...
    'Task: 100 us | Limit: |Ia| or |Ib| > 12 A\n' ...
...
annotation = Simulink.Annotation(parent, sprintf([ ...
    ...
    'Task: 1 ms | |speed| <= 3000 rpm | 10 V <= Vdc <= 60 V']));
...
% numeric 2 V d-axis, zero-q-axis and fixed-angle trigonometric selection.
Simulink.SubSystem.deleteContents(parent);
...
constantNames = {'Align_Vd_2V', 'Align_Vq_Zero', ...
    'Align_Sin_Zero', 'Align_Cos_One'};
constantValues = {'single(2.0)', 'single(0.0)', ...
...
annotation = Simulink.Annotation(parent, sprintf([ ...
    ...
    'Parameters: Vd=2 V, Vq=0 V, sin(theta)=0, cos(theta)=1 | Task: 100 us']));
...
annotationText = sprintf(['STATEFLOW MOTOR SUPERVISOR V2.1.0\n' ...
    ...
    'CALIB: 100 fast samples | ALIGN: 20 ms at Vd=2 V\n' ...
    'Fast fault: |Iab| > 12 A; slow faults: |speed| > 3000 rpm or Vdc outside 10..60 V\n' ...
